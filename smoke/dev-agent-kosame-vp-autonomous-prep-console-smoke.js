...
const tool = require('../tools/kosame-vp-autonomous-prep-console.js');

console.log('=== kosame-vp-autonomous-prep-console smoke ===');

const pkg = JSON.parse(fs.readFileSync(path.join(__dirname, '../package.json'), 'utf8'));
const docPath = path.join(__dirname, '../docs/ai-dev-team/kosame-dev-orchestra-v4.5.0-release-record.md');
const fixturePath = path.join(__dirname, '../fixtures/kosame-vp-autonomous-prep-console.sample.json');

assert.strictEqual(pkg.version, '4.5.0', 'package version 4.5.0');
console.log('  PASS: package version 4.5.0');

assert.ok(pkg.scripts['smoke:kosame-vp-autonomous-prep-console'], 'script exists: smoke:kosame-vp-autonomous-prep-console');
...
assert.strictEqual(tool.TOOL_META.version, '4.5.0', 'tool meta version');
...
console.log('PASS: kosame-vp-autonomous-prep-console');
