...
// Smoke test for v0.1.7 OpenAI one-shot live call success record.
...
const FILES = {
  successRecord: path.join(root, "docs/ai-dev-team/openai-one-shot-success-record-v0.1.7.md"),
};

console.log("===== dev-agent-openai-one-shot-success smoke =====");

console.log("--- file existence checks ---");
checkFile("openai-one-shot-success-record-v0.1.7.md", FILES.successRecord);
...
checkKeyword("success-record", FILES.successRecord, "provider: gpt");
