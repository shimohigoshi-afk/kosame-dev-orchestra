...
assert.strictEqual(pkg.version, '110.16.0');
pass('package version is 110.16.0');

assert.strictEqual(executor.TOOL_META.version, '110.16.0');
pass('tool meta version is 110.16.0');
