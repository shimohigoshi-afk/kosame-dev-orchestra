 ...
 *   - Fix 3: version 110.52.0 in auto-dev.js and package.json
...
pass('TOOL_META.version is 110.52.0');
assert.strictEqual(pkg.version, '110.52.0');
pass('package.json version is 110.52.0');
