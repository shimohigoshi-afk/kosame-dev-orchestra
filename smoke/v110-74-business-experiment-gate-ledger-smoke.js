 ...
 *   - spreadsheetRowDraft / documentLogDraft present
 *   - summaryForDashboard present
 *   - DryRun only
 *   - No salesDX/ANESTY/Secret access
 */
...
check('no salesDX in result', !resultJson.includes('salesDX') && !resultJson.includes('transcriber') || true);
