...
assert.ok(html.includes('sound-toggle'), 'HTML must include notification sound toggle');
assert.ok(html.includes('sound-test'), 'HTML must include notification sound test button');
