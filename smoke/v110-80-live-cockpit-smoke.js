...
include(html, '通知音', 'HTML');
include(html, 'ON', 'HTML');
include(html, 'OFF', 'HTML');
include(html, 'テスト音', 'HTML');
include(html, 'ブラウザ操作後に有効化してください', 'HTML');
assert.ok(html.includes('id="sound-toggle"'), 'HTML must include notification sound toggle');
assert.ok(html.includes('id="sound-test"'), 'HTML must include notification sound test button');
