...
assert.ok(html.includes('sound-mode-row'), 'HTML must include notification mode button row');
assert.ok(html.includes('sound-btn-${spec.mode}'), 'HTML must include OFF/Soft/Clear mode button template');
assert.ok(html.includes('sound-test'), 'HTML must include test button');
assert.ok(html.includes('chat-sound-details-compact'), 'HTML must include collapsed notification test details');
assert.ok(html.includes('sound-mode-row'), 'HTML must include sound mode disclosure');
assert.ok(html.includes('こさめ質問音'), 'HTML must include question test button');
assert.ok(html.includes('HUMAN_GATE音'), 'HTML must include human gate test button');
assert.ok(html.includes('DONE音'), 'HTML must include done test button');
assert.ok(html.includes('ERROR音'), 'HTML must include error test button');
