...
assert.ok(html.includes('stage-trace'), 'HTML must include trace class');
assert.ok(html.includes('stage-dots'), 'HTML must include dots class');
assert.ok(html.includes('stage-blip'), 'HTML must include blip class');
...
assert.ok(!html.includes('stage-halo'), 'HTML must not include halo class');
assert.ok(!html.includes('stage-ring-a'), 'HTML must not include ring class');
assert.ok(!html.includes('stage-arc'), 'HTML must not include arc class');
