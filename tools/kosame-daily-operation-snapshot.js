...
const TOOL_META = {
  "version": "4.2.0",
  "title": "Kosame Daily Operation Snapshot Pack",
  "slug": "kosame-daily-operation-snapshot",
  "tool": "tools/kosame-daily-operation-snapshot.js",
  "smoke": "smoke/dev-agent-kosame-daily-operation-snapshot-smoke.js",
  "doc": "docs/ai-dev-team/kosame-dev-orchestra-v4.2.0-release-record.md",
  "fixture": "fixtures/kosame-daily-operation-snapshot.sample.json",
  "purpose": "こさめ副社長 can summarize daily repo state, actions status, package version, and next action in dry-run mode.",
  "script": "smoke:kosame-daily-operation-snapshot"
};
