...
const ROADMAP = {
  ...
  phases: [
    ...
    { id:'v115.0.0', phase:'FK大宮Console Branch', summary:'FK大宮向けConsoleをブランチ分離。既存repoへの混入を防ぎつつ、専用UI/知識ベースを持つ。', deps:['v114.5.0'], model:'deepseek-v4-pro', diff:'high', conf:'safe', gate:false, audit:true, deliverables:['fk-omiya branch','fk console router','fk knowledge schema'] },
    { id:'v115.1.0', phase:'FK Knowledge Console MVP', summary:'FK大宮の不動産知識・地域データベースをConsoleで検索・表示できるようにする。', deps:['v115.0.0'], model:'deepseek-v4-pro', diff:'high', conf:'safe', gate:false, audit:true, deliverables:['knowledge search ui','region filter','property detail view'] },
