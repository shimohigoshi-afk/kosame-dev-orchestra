...
const TOOL_META = {
  "version": "4.1.0",
  "title": "Kosame Self Operation Smoke Pack",
  "slug": "kosame-self-operation-smoke",
  "tool": "tools/kosame-self-operation-smoke.js",
  "smoke": "smoke/dev-agent-kosame-self-operation-smoke.js",
  "doc": "docs/ai-dev-team/kosame-dev-orchestra-v4.1.0-release-record.md",
  "fixture": "fixtures/kosame-self-operation-smoke.sample.json",
  "purpose": "v4.0.0 Practical Operating Console outputs can be checked without Claude or Gemini.",
  "script": "smoke:kosame-self-operation-smoke"
};
