...
const TOOL_META = {
  "version": "4.5.0",
  "title": "Kosame VP Autonomous Prep Console",
  "slug": "kosame-vp-autonomous-prep-console",
  "tool": "tools/kosame-vp-autonomous-prep-console.js",
  "smoke": "smoke/dev-agent-kosame-vp-autonomous-prep-console-smoke.js",
  "doc": "docs/ai-dev-team/kosame-dev-orchestra-v4.5.0-release-record.md",
  "fixture": "fixtures/kosame-vp-autonomous-prep-console.sample.json",
  "purpose": "こさめ副社長 can prepare the next operation plan, approval summary, recovery path, and handoff without executing dangerous actions.",
  "script": "smoke:kosame-vp-autonomous-prep-console"
};
