...
function generateFirstDeployResultTemplate(options) {
  ...
  return {
    ...
    record: {
      ...
      n8nConnectionResult: "PENDING (not yet tested / pass / fail — v0.4.2 n8n接続後に記録)",
      nextVersionCandidate: "v0.5.0 候補: dryRunOnly: false 移行 / Secret Manager 本格接続 / Cloud Run Invoker 認証追加",
      troubleshootingNotes: "PENDING (none / 問題発生時の対応記録 — docs/ai-dev-team/cloud-run-first-deploy-troubleshooting-v0.4.1.md 参照)",
